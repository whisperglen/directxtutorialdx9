...
static LPDIRECT3DVERTEXBUFFER9 v_buffer2;
static int trianglepsychedelic_init_done = 0;
static int trianglepsychedelic_do_init(LPDIRECT3D9 d3d, LPDIRECT3DDEVICE9 device)
{
	// create three vertices using the CUSTOMVERTEX struct built earlier
	CUSTOMVERTEX t_vert[] =
	{
	...
	trianglepsychedelic_init_done = 1;
	return 0;
}
...
int trianglepsychedelic(LPDIRECT3D9 d3d, LPDIRECT3DDEVICE9 device)
{
	...
	if (trianglepsychedelic_init_done == 0)
		if (0 != trianglepsychedelic_do_init(d3d, device))
			return -1;
...
static LPDIRECT3DVERTEXBUFFER9 v_buffer3;
static int triangledepth_init_done = 0;
static int triangledepth_do_init(LPDIRECT3D9 d3d, LPDIRECT3DDEVICE9 device)
{
	// create three vertices using the CUSTOMVERTEX struct built earlier
	CUSTOMVERTEX t_vert[] =
	{
...
int triangledepth(LPDIRECT3D9 d3d, LPDIRECT3DDEVICE9 device)
{
	...
	if (triangledepth_init_done == 0)
		if (0 != triangledepth_do_init(d3d, device))
			return -1;
